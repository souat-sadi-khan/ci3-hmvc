<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="<?= base_url() ?>">
            <img src="<?= base_url() . 'assets/images/favicon.ico' ?>" alt="logo"/>
        </a>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="images/face.jpg" alt="image" class="profile-pic">
                        </div>
            ...
            <li class="nav-item nav-profile dropdown">
                <?php 
                    $ur = $this->db->from('techics_users')->where('id', $this->session->userdata('id'))->get()->row();
                ?>
                <a class="nav-link" href="javascript:;" data-toggle="dropdown" id="profileDropdown">
                    <img src="<?= $ur->photo != '' ? base_url() . $ur->photo : base_url() . 'assets/images/user.png' ?>" alt="profile"/>
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                    ...
                    <a href="javascript:;" id="logout" data-url="<?= site_url('administrator/logout') ?>" class="dropdown-item">
